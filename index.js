...
const manifest = {
  ...
  config: [
    { key: 'provider_yifi', type: 'checkbox', title: 'YIFI (yifysubtitles.ch)', default: true },
    { key: 'provider_s4f',  type: 'checkbox', title: 'S4F (subs4free/subs4series)', default: true },
    { key: 'provider_subz', type: 'checkbox', title: 'SUBZ (greeksubs.net)', default: true }
  ]
};
...
console.log(`✅ Greek Subs running → ${BASE_URL}/manifest.json`);
